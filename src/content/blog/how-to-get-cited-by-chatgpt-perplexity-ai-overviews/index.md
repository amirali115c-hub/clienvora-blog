...
meta_title: "How to Get Cited by ChatGPT, Perplexity, and AI Overviews"
...
- Build a [topical authority cluster](/blog/topical-authority-cluster/) so Gemini sees depth, not one off pages.
...
They also reward freshness and trust. A page that looks current and authoritative is more likely to be the one Google summarizes. This is where the [May 2026 Preferred Sources](/blog/google-2026-search-updates/) change matters, covered later in this post.
...
1. **Retrieval:** Am I indexed and ranked where this engine looks? (Bing for ChatGPT, own crawler for Perplexity, Google top 10 for AIO, entity for Gemini)
2. **Answer first:** Does the first paragraph answer the query in under 40 words?
3. **Schema:** Is Article or FAQ schema present and valid?
4. **Freshness:** Was the page updated within the last 30 days?
5. **Sources:** Are claims attached to named, credible sources?
6. **Entity:** Are my brand name, logo, and URLs consistent everywhere?
7. **Earned media:** Do third party sites reference this claim back to me?
...
Third, check trust. A lone claim with no source and no entity backing gets summarized and dropped. Attach a citation, strengthen your [experience signals over keywords](/blog/eeat-why-experience-beats-keywords/), and earn a third party mention. The model cites sources it can defend.
...
Treat Preferred Sources as a multiplier on work you already did. Rank in the top 10, keep the page fresh, and add FAQ schema, then the opt-in nudges the overview to name you. It does not rescue a page that fails the basics. This lines up with the broader [2026 search updates](/blog/google-2026-search-updates/) that reward demonstrable topical ownership.

For a wider lens on how this fits the discipline, our [GEO versus SEO versus AEO](/blog/geo-vs-seo-vs-aeo/) guide separates the three plays, and our [GEO services and agencies](/blog/geo-services-and-agencies/) page explains where outside help pays off.
...
- [EEAT: Why Experience Beats Keywords](/blog/eeat-why-experience-beats-keywords/)
